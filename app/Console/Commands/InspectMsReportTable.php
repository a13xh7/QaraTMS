...
class InspectMsReportTable extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'inspect:ms-report';
     ...
     * @var string
     */
    protected $description = 'Inspect the testreport.ms_report table structure';
    ...
    {
        $this->info('Inspecting testreport.ms_report table...');
        ...
        // Get columns
        try {
            $columns = Schema::connection('testreport')->getColumnListing('ms_report');
            
            if (empty($columns)) {
                $this->error('No columns found in ms_report table.');
                return 1;
            }
            
            $this->info('Columns in ms_report table:');
            ...
            $sampleRow = DB::connection('testreport')->table('ms_report')->first();
            ...
            if ($sampleRow) {
                ...
                $this->warn('No data found in ms_report table.');
            }
