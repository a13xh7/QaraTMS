...
class PopulateSettings extends Command
{
     ...
     * @var string
     */
    protected $description = 'Populate the settings table with default values';
    ...
    public function handle()
    {
        ...
        foreach ($settings as $setting) {
            ...
            if (!$exists) {
                ...
                $this->line("Added setting: {$setting['key']}");
            } else {
                $this->line("Setting already exists: {$setting['key']}");
            }
        }

        $this->info('Settings table populated successfully!');
