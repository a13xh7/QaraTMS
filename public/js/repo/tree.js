            ...
            <div class="contents">
                ...
                <div class="branch-wrapper position-relative">
                    ...
                    <div class="right-sidebar d-flex justify-content-end position-absolute end-0">
                        ...
                        <button id="edit_suite_btn" type="button" class="button edit_suite_btn" title="Edit" onclick="showSuiteForm('edit', ${mid ? mid : id})">
                            <i class="bi bi-pencil"></i>
                        </button>

                        <button id="add_child_suite_btn"  type="button" class="button add_child_suite_btn" title="Add child test suite" onclick="showSuiteForm('create', ${mid ? mid : id})">
                            <i class="bi bi-folder-plus"></i>
                        </button>

                        <button  id="delete_suite_btn"  type="button" class="button remove-branch delete_suite_btn" title="Delete" onclick="deleteSuite(${mid ? mid : id})">
