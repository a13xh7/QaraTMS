    ...
    <div class="flex-grow-1">
        <div class="container-fluid p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h3 class="page-title mb-1">Defect Analytics Dashboard</h3>
                    <p class="text-muted mb-0">Analyze and track defect trends and patterns</p>
                </div>
            </div>
            ...
            <div class="card shadow-sm">
                <div class="card-body construction-container">
                    ...
                    <h2 class="construction-title">Defect Analytics Coming Soon</h2>
                    <p class="construction-message">
                        We're building a powerful defect analytics system to help you identify trends, patterns, and areas for improvement.
