...
@section('content')
    ...
    <div class="col-3 shadow" id="suites_tree_col">
...
{{--        <button type="button" class="btn btn-outline-dark btn-sm w-100">ROOT</button>--}}
    ...
    <div id="test_cases_list_col" class="col shadow">
        {{-- COLUMN header--}}
        <div class="border-bottom mt-2 pb-2 mb-2 d-flex justify-content-between">
...
@section('footer')
        ...
        <script src="{{asset('repository/test_suite.js')}}"></script>
        <script src="{{asset('repository/test_case.js')}}"></script>
